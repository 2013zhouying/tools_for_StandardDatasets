...
<table>
    ...
    <tr> 
        <th> person  </th>  
        <th> 687 </th> 
        <th> 来源于ONE R上采集筛选的有难度的视频帧（592张）， 以及产品经理反馈的效果不佳的产品视频帧(95张)。  人工PS标注或凡科快图辅助标注。   </th> 
        <th> val  </th> 
        <th> val.txt  </th>  
        <th> 687 </th> 
        <th> 440 x 342  </th> 
    ...
    <tr> 
        ...
        <th> 592 </th> 
        <th>  -  </th> 
        <th> 基础测试，ONE R上采集筛选的有难度的视频帧，可用于检查改进模型是否过拟合  </th>   
    </tr>
    <tr> 
        <th> person  </th>  
        <th> 687 </th> 
        <th> 来源于ONE R上采集筛选的有难度的视频帧（592张）， 以及产品经理反馈的效果不佳的产品视频帧(95张)。  人工PS标注或凡科快图辅助标注。   </th> 
        <th> insta360 hard  </th> 
        <th> insta360hard.txt  </th>  
        <th> 95 </th> 
        <th>  -  </th> 
        <th> 来自产品经理反馈的效果不佳的4个产品视频的抽帧，可用于检查改进模型是否符合产品经理的期望  </th>   
    </tr>
</table>
